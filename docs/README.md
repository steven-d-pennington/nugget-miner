...
Planning and implementation docs derived from the
[Nugget PRD](../Nugget_PRD.md).

## Structure

- **[`product/`](./product/)** — the PM foundation every task builds on:
  - [`00-product-spec.md`](./product/00-product-spec.md) — product decisions + feature catalog
...
- `qa/` — manual QA checklist (created by EPIC-11).

Start at [`tasks/README.md`](./tasks/README.md).
</content>
