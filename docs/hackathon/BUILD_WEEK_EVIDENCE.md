...
This is a two-call production smoke, not the 12-fixture canonical live
evaluation: it does not create `docs/evals/latest.json`, report a canonical
score, or close the Sprint 2 live-evaluation gate. Coordinator verification on
